...
public class SaveNewProductHandler implements RequestHandler<ProductRequest, String> {

    private DynamoDB dynamoDb;
    private String DYNAMODB_TABLE_NAME = "ProductStore";
    private Regions REGION = Regions.US_EAST_1;

    public String handleRequest(ProductRequest inputRequest, Context context) {
        
        try{
        	this.init();
        	if(inputRequest !=null)
        	persistData(inputRequest);
        } 
